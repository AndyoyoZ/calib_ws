...
//参数
float angular_resolution_x = 0.1f,//angular_resolution为模拟的深度传感器的角度分辨率，即深度图像中一个像素对应的角度大小
      angular_resolution_y = angular_resolution_x;
pcl::RangeImage::CoordinateFrame coordinate_frame = pcl::RangeImage::CAMERA_FRAME;//LASER_FRAME深度图像遵循坐标系统
...
*/ 
  range_image.createFromPointCloud (point_cloud, angular_resolution_x, angular_resolution_y,pcl::deg2rad (360.0f), pcl::deg2rad (30.0f),scene_sensor_pose, coordinate_frame, noise_level, min_range, border_size);
